"""Log analysis tool implementations exposed by the MCP-style tool server."""
...
LOGS_DIR = Path(__file__).resolve().parent.parent / "sample_logs"
...
def analyze_logs(
    ...
    """Analyze the specified log file and return structured matches and a summary."""
...
def get_recent_errors(last_n_lines: int = 10) -> dict:
    """Read all three log files and return only the ERROR-level lines from each."""
